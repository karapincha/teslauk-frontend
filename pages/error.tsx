    ...
    <>
      ...
      <CommonLayout>
        <div className='container pt-[24px] md:pt-[40px] lg:pt-[40px]'>
          <div className='flex flex-col items-center rounded-[8px] bg-white py-[48px] px-[16px] md:py-[132px] md:px-[64px] lg:px-0'>
            ...
            <p className='w-full pt-[16px] text-center text-base text-N-600 lg:w-[46%]'>
              We are embarassed! Human Error is inevitable, but this is unacceptable. We'll look
              into the matter now.
            </p>
