...
const Page: NextPage = () => {
  return (
    <>
      ...
      <CommonLayout>
        <div className='container flex pb-[24px] md:pt-[40px] md:pb-[80px]'>
          <PageHeader
        ...
        <div className='container flex flex-col'>
          <article className='prose mx-auto max-w-[782px] pt-[24px] md:py-[80px]'>
            <p>
              Thank you for offering to pass on your expertise and experiences by writing content
              for other owners in the UK, it’s really appreciated by not only the Tesla Owners UK
              team but also all UK Tesla Owners.
            </p>
            ...
            <ul>
              <li>
                Useful and unique content for the website to help other owners similar to you that
                may not have the full understanding of a particular task or issue.
              </li>
            ...
            <ol>
              <li>
                ...
                already exists or another could be slightly amended to add the content you’re
                thinking of creating. If you wish to make changes to an existing article visit the
                article and at the bottom click on ‘Like or Dislike’ and a box will appear to
                provide feedback, this gets checked by the team periodically and changes will be
                made ASAP.
              </li>
              <li>
                ...
                plan to write lots of content please get in touch with the web manager who can help
                by swapping your account to an Author.
              </li>
            </ol>
            ...
            <ul>
              ...
              <li>
                If you wish to provide more help (e.g. writing multiple articles or amending
                existing)
                <a> speak with the Web Manager</a> or who can help further by swapping your account
                to an ‘Author’.
              </li>
            </ul>
