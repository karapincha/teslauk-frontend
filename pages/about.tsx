      ...
      <div className='container pt-[64px] pb-[80px] px-[100px]'>
        <div className='flex gap-[48px]'>
          ...
          <p className='text-base font-500 text-N-800'>
            ...
            and adoption of electric vehicles, renewable energy & zero carbon living; and fostering
            of good relations between Members, Staff, and other supporters of Tesla, and other
            parties who seek to achieve similar aims and purposes to the Club.
            <br />
            <br />
            ...
            the fun really starts with our in-person events (3 per month across the UK); track days
            (12 per year); large scale events (circa 200+ owners per event); road trip events;
            finally numerous discussion groups (circa 32,000 posts with 543,000 comments per year)
            and guides on our website ensure continued support throughout all aspects of ownership.
          </p>
        </div>
      </div>
