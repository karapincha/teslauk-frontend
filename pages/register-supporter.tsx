            ...
            <div className='w-full rounded-b-[8px] bg-white px-[16px] py-[32px] md:px-[40px] md:py-[32px] lg:px-[40px] lg:py-[32px]'>
              ...
              <div className='flex flex-col gap-[16px] pt-[24px]'>
                ...
                <div className='flex flex-col gap-[8px]'>
                  ...
                  />
                  <p className='text-sm font-500 text-N-600'>
                    So we can print your name badge please supply your name as you would like it to
                ...
                <div className='flex flex-col gap-[8px]'>
                  ...
                  <p className='text-sm font-500 text-N-600'>
                    ...
                    town/city) e.g. Milton Keynes. This will appear directly below your name on your
                    badge.
                  </p>
                </div>
