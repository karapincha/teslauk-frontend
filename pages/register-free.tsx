  ...
  return (
    <>
      ...
      <div className='container flex flex-col items-center rounded-[12px] bg-[url(/images/hero-pattern.svg)] py-[32px] lg:pt-[40px] lg:pb-[80px]'>
        ...
        <div className='w-full pt-[8px] md:w-[672px] md:pt-[16px] lg:w-[672px] lg:pt-[32px]'>
          <div className='w-full rounded-[8px] bg-white px-[16px] py-[24px] md:px-[40px] md:py-[32px] lg:px-[40px] lg:py-[32px]'>
            ...
            <div className='flex flex-col gap-[16px]'>
              ...
              <div className='flex justify-between gap-[48px]'>
                ...
                <img src='/images/model-3.png' height={138} width={264} />
              </div>
              ...
              <p className='!after:content-[*] !after:text-B-500 text-md font-500 text-N-600 after:ml-[2px]'>
            ...
            <div className='flex flex-col gap-[24px] pt-[24px]'>
              <div className='w-[unset]'>
                <Link href='#'>
                  <Button className='text-base !font-600' appearance='primary'>
                    Register Now
                  </Button>
                </Link>
              </div>
