...
import { SIGNUP_FREE_MEMBER, ADD_TO_CART, CHECKOUT, GET_CART, CLEAR_CART } from '../../lib/graphql'
...
const Page: NextPage = () => {
  ...
  const handleSubmit = (e: any) => {
    ...
    // if (!privacyPolicy) {
    //   toast({ message: 'Please agree to Rules and Privacy Policy', type: 'error' })
    //   return
    // }
  }
            ...
            <div className='w-[90%] pt-[32px] md:w-[672px] md:pt-[32px] lg:w-[672px] lg:pt-[32px]'>
              <div className='w-full rounded-[8px] bg-white px-[16px] py-[32px] md:px-[40px] md:py-[32px] lg:px-[40px] lg:py-[32px]'>
                ...
                <div className='flex flex-col gap-[24px] pt-[24px] lg:pt-[16px]'>
                  <div className='flex w-full gap-[12px] lg:w-[unset]'>
                    <Button
