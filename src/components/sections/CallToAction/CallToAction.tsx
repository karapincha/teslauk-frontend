...
export const CallToAction: FC<CallToActionProps> = ({
  ...
  return (
    <div className={CallToActionClasses} {...restProps}>
      <div className='container relative flex min-h-[482px] w-[calc(100%-20px)] flex-col-reverse items-center rounded-[12px] bg-white py-[24px] md:relative md:min-h-[562px] md:flex-col-reverse lg:relative lg:min-h-[400px] lg:py-[72px] lg:px-[100px] gap-[48px]'>
        ...
        <div className='lg:ml-auto flex text-center lg:max-w-[472px] lg:pt-0 lg:text-left lg:flex lg:justify-center'>
          <SectionHeading
